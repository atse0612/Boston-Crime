...
## Removing the NA and dropping columns
  ...
  dashboardBody(
    ...
    tabItems(
      ...
      tabItem(
        tabName = "extra5",
        fluidRow(
          box(title = "Crime Database", color = "navajowhite1", ribbon = TRUE, 
...
# Top Group of Crimes Per Day
  ...
  ## Orginally a line graph in Tableau, and only barplot work on the app
